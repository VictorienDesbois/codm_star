...
for i in "${seq[@]}"; do
	...
	cmd1="./$shell_script.sh $time_limit $memory_limit $algo small_obstacles_range3_3d_agents${i}_ $swapping_conflicts"
	cmd2="./$shell_script.sh $time_limit $memory_limit $algo pyramid_range3_3d_agents${i}_ $swapping_conflicts"
	cmd3="./$shell_script.sh $time_limit $memory_limit $algo offices_range1_agents${i}_ $swapping_conflicts"
	cmd4="./$shell_script.sh $time_limit $memory_limit $algo parallel_range4_agents${i}_ $swapping_conflicts"
